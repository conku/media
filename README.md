...
[![GoDoc](https://godoc.org/github.com/conku/media?status.svg)](https://godoc.org/github.com/conku/media)
...
Then add [OSS(Object Storage Service)](https://github.com/conku/oss) to your model:
...
The [OSS(Object Storage Service)](https://github.com/conku/oss) provides a pretty simple API to operate files on filesytem or cloud storage
...
To avoid this problem, we made a safer `FileServer` function [here](https://github.com/conku/qor/blob/master/utils/utils.go#L176). This function serves file only. So the previous code now turned into:
